...
Applying 'GoogLeNet' to CIFAR-10 dataset classification task.
References:
...
network = regression(loss, optimizer='momentum',
                     ...
                     learning_rate=0.001)
model = tflearn.DNN(network, checkpoint_path='checkpoint_cifar10/model_googlenet',
                    max_checkpoints=1, tensorboard_verbose=2)
model.fit(X, Y, n_epoch=200, validation_set=(testX, testY), shuffle=True,
          show_metric=True, batch_size=64, snapshot_step=200,
          snapshot_epoch=False, run_id='googlenet_cifar10')

model.save('model/cifar10_retrained_by_googlenet')