...
if __name__=="__main__":
    folder="../../dataset/12_classes/train_img_resized_256"
    dir_path="../../dataset/12_classes/dataset-batches-py-256"
    ...
    for j in range(1,batch+1):
        ...
        binpath="../../dataset/12_classes/dataset-batches-py-256/train_batch_%s" % str(j)
