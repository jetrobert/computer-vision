...
# image preprocessing.
# for train dataset random crop, flip left to right，hue, contrast..
...
# plot 3*3 figures in one big figure
...
# calculate each prediction accuracy
