...
def _print_success_message(name):
...
def test_normalize(normalize):
    ...
    _print_success_message('Normalize')
...
def test_one_hot_encode(one_hot_encode):
    ...
    _print_success_message('One_hot_encode')
...
def test_con_pool(conv2d_maxpool):
    ...
    _print_success_message('Con_pool')
...
def test_fully_conn(fully_conn):
    ...
    _print_success_message('Fully_conn')
...
def test_train_nn(train_neural_network):
    ...
    _print_success_message('Train_nn')
