...
def conv2d_maxpool(x_tensor, conv_num_outputs, conv_ksize, conv_strides, pool_ksize, pool_strides):
    ...
    activation_conv_layer_out = tf.nn.relu(conv_layer_out_bn)
...
def conv_net(x, keep_prob):
    ...
    conv_maxpool_output_third = conv2d_maxpool(conv_maxpool_output_second, 
                                                ...
                                                pool_ksize = [2, 2], 
                                                pool_strides = [2, 2])
    conv_maxpool_output_third = tf.nn.dropout(conv_maxpool_output_third, keep_prob)
    ...
    fc_output = fully_conn(flatten_conv_maxpool_output, num_outputs = 256)
    fc_output = tf.nn.dropout(fc_output, keep_prob)
    
    # TODO: Apply an Output Layer
    #    Set this to the number of classes
    # Function Definition from Above:
    #   output(x_tensor, num_outputs)
    final_output = output(fc_output, num_outputs = 10)
